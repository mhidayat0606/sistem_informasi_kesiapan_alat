<div class="pagetitle">
	...
	<nav>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Laporan Alat Perbaikan</li>
		</ol>
	</nav>
</div>
			...
			<div class="card">
				<div class="card-body">
					...
					<table class="table datatable">
						...
						<?php 
							$query = mysqli_query($koneksi, "SELECT * FROM alat WHERE nama_user = '$nama' AND status = 'Perbaikan' ");
							$no = 1;
